  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/animals" element={<AnimalsList animals={animals} />} />
        <Route
          path="/animals/:name"
          element={<AnimalDetails animals={animals} />}
        />
